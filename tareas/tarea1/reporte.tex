...
\item Utilizar la siguiente heurística para aplicar al ejercicio anterior el algoritmo de A$^*$ (dibujar árbol y pila): % Ejercicio 6
  \begin{center}
  ...
  \textbf{R: } \input{respuestas/ejercicio6.tex}
...
\item Demostrar que si $h(s_t),\, s_t \in S$, es una heurística admisible para el algoritmo de A$^*$, entonces el algoritmo de A$^*$ encontrará una solución óptima.
