...
\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        $s_0$ & $(s_2:0)$ & $s_0$ \\
        \hline
        $s_2$ & $(s_4:3), (s_1:21)$ & $s_0,s_2$ \\
        \hline
        $s_4$ & $(s_3:6), (s_5:10), (s_1:21)$ & $s_0,s_2,s_4$\\
        \hline
        $s_3$ & $(s_5:10), (s_1:21)$ & $s_0,s_2,s_4, s_3$\\
        \hline
        $s_5$ & $(s_7:20), (s_1:21), (s_6:32)$ & $s_0,s_2,s_4, s_3, s_5$\\
        \hline
        $s_7$ & Estado final & $s_0,s_2,s_4, s_3, s_5, s_7$\\
        \hline
    \end{tabular}
\end{center}
