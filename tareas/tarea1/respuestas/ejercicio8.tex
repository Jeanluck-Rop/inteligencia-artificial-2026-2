...
Podemos ver lo que sucede en el siguiente árbol

\begin{center} 
    \includegraphics[height = 4cm]{respuestas/img/treeE8.png}
\end{center}

Notemos que con una cola de prioridad para la frontera no es posible llegar al estado final con este valor de $k$ con lo que se generaron $5$ caminos pero ninguno fue exitoso.\\
